...
const components = {
	...
	h3: (props: ComponentPropsWithoutRef<"h3">) => (
		<h3
			{...props}
			className={cn(
				"flex mt-2 mb-4 text-xl leading-snug dark:text-light-100",
				props.className,
			)}
		>
			{props.children}
	...
	p: (props: ComponentPropsWithoutRef<"p">) => (
		<p
			{...props}
			className={cn(
				"mb-4 text-base leading-8 md:leading-7 dark:text-light-200",
				props.className,
			)}
		/>
	),
	...
	hr: (props: ComponentPropsWithoutRef<"hr">) => (
		<hr
			{...props}
			className={cn(
				"my-12 border-gray-300 dark:border-portgore-600",
				props.className,
			)}
		/>
	),
	...
	tips: (props: TipsProps) => <Tips {...props} />,
};
