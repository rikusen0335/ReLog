    ...
    return (
        <Link href={`/works/${slug}`}>
            <div className="relative h-[500px] dark:brightness-[90%] group hover:cursor-pointer transition duration-150">
                <img src={thumbnail} className="h-[500px] w-full object-cover brightness-[30%] lg:brightness-[90%] group-hover:brightness-[30%] group-hover:grayscale-[0.4] ease-out transition duration-150" />
                <div className="absolute inset-0 flex flex-col p-16 transition duration-150 lg:hidden group-hover:flex">
                    <h2 className="text-3xl font-bold lg:text-4xl text-light-100">{title}</h2>
