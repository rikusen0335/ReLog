...
const postsDirectory = join(process.cwd(), "/_contents/posts");
...
const allWorks: Work[] = [
  ...
  // },
  {
    ...
    subtitle: '"Mecha-kun"',
    introduction:
      "スタイリッシュな人型ロボットを作りたくて、Blenderの勉強ついでに作りました。",
    description:
      "性癖つめつめなスタイリッシュ人型ロボットを作りたくて、Blenderの勉強ついでに作りました。制作時間は20時間ぐらい？\nVRCのアバターとして改造して使ったり、配信で自分のアバターとして使ったりしてます。\n正直性癖をまだまだ突き詰められていないので、ロボ・サイボーグなどが好きな方は声かけてもらえるとありがたいです！Twitterでもいいのでお願いします。",
    used: ["Blender", "Unity", "VRChat"],
    thumbnail: "/assets/works/images/3dmodel-mechakun/21.png",
    images: [
      {
        source: "/assets/works/images/3dmodel-mechakun/1.png",
        alt: "ラフの段階ではそもそも足のスパイラルを作りたかっただけだった",
      },
      { source: "/assets/works/images/3dmodel-mechakun/2.png" },
      {
        source: "/assets/works/images/3dmodel-mechakun/3.png",
        alt: "最初は首と顔が一緒の形状でした",
      },
      { source: "/assets/works/images/3dmodel-mechakun/4.png" },
      {
        source: "/assets/works/images/3dmodel-mechakun/5.png",
        alt: "あまり意味のないタンク形状のなにかも付いてる",
      },
      ...
      {
        source: "/assets/works/images/3dmodel-mechakun/12.png",
        alt: "ウェイトペイントが楽でいい",
      },
      { source: "/assets/works/images/3dmodel-mechakun/13.png" },
      { source: "/assets/works/images/3dmodel-mechakun/14.png" },
      {
        source: "/assets/works/images/3dmodel-mechakun/16.png",
        alt: "足がバグって3日ぐらいUnityとマジで格闘しました",
      },
      {
        source: "/assets/works/images/3dmodel-mechakun/15.png",
        alt: "直ったときは本当になんか言葉にできない達成感を感じた...",
      },
      { source: "/assets/works/images/3dmodel-mechakun/17.png" },
      {
        source: "/assets/works/images/3dmodel-mechakun/18.png",
        alt: "色ついてないけどとりあえず完成",
      },
      { source: "/assets/works/images/3dmodel-mechakun/19.png" },
      { source: "/assets/works/images/3dmodel-mechakun/20.png" },
      {
        source: "/assets/works/images/3dmodel-mechakun/21.png",
        alt: "目の部分はしゃべると点滅します",
      },
      {
        source: "/assets/works/images/3dmodel-mechakun/22.png",
        alt: "Animazeのすがた",
      },
      {
        source: "/assets/works/images/3dmodel-mechakun/23.png",
        alt: "Twitterのアイコンに使ってました",
      },
      {
        source: "/assets/works/images/3dmodel-mechakun/24.png",
        alt: "同様に、色味だけ変更",
      },
    ],
  },
  {
    ...
    introduction:
      "なんでも好き勝手できるブログ作りてーと思ってたらできてました。",
    description:
    ...
    images: [{ source: "/assets/works/images/nextjs-blog-relog/1.png" }],
  },
  {
    slug: "nodecg-bundle-luckgamerta",
    title: "LuckGameRTA用のNodeCGバンドル",
    introduction:
      "LuckGameRTAという運ゲーRTAのイベントのためのバンドルを作成しました。",
    description:
      "LuckGameRTAという運ゲーRTAのイベントのために、NodeCGといわれるRTAでよく使われているフレームワーク用のバンドルを作成しました。\n今回はブランディングに応じたカスタムスタイルを書く必要がなかったので、Chakra UIを使用して簡易的にUXを提供しています。",
    ...
    images: [
      {
        source: "/assets/works/images/nodecg-bundle-luckgamerta/1.jpg",
        alt: "実際のTwitchでの放送時の画面",
      },
      { source: "/assets/works/images/nodecg-bundle-luckgamerta/2.jpg" },
      { source: "/assets/works/images/nodecg-bundle-luckgamerta/3.png" },
      {
        source: "/assets/works/images/nodecg-bundle-luckgamerta/gif_1.gif",
        alt: "Replicantを使用して、リアルタイムにグラフィック側を変更",
      },
      {
        source: "/assets/works/images/nodecg-bundle-luckgamerta/gif_2.gif",
        alt: "日付ごとの走者情報の変更",
      },
    ],
  },
